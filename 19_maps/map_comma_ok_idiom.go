// Demonstrates safe map access using the comma-ok idiom in Go.
// Shows how to check if a key exists before using its value.
// Includes examples of both direct and inline if usage.
package main
