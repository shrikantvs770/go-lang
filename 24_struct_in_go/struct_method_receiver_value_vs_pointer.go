// Illustrates the difference between value and pointer receivers for struct methods.
// Shows how only pointer receivers can modify the original struct fields.
package main
